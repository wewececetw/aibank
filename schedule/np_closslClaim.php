...
do{
    ...
    if($tr_cnt==0){                 //確認是否開標
        $e1=" 轉換";
        $e3="=> 結案";
        $sql="update claims set claim_state = 5 , updated_at = '".$nt."' where claim_id='".$row["claim_id"]."';";
        //echo $sql."<br>";
        mysqli_query($link,$sql);
        $sql="update tender_documents set tender_document_state = 4 , updated_at = '".$nt."' where claim_id='".$row["claim_id"]."';";
        mysqli_query($link,$sql);
        //echo $sql."結案<br>";
    }
