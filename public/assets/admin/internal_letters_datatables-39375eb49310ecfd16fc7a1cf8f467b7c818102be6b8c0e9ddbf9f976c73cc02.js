...
$(function() {
    ...
    // 列表頁的 datatables 設定
    $('.internal_letters_table').each(function(){
        var table = $(this);
        ...
        var datatable = table.DataTable({
            ...
            dom: 'Brtip"bottom"l',
            ajax: {
                url: '/admin/internal_letters/datatables.json',
                dataSrc: 'data',
                type: 'POST',
                data: {
                },
            ...
            columns:[
                ...
                {
                    data: 'deleted_at',
                    name: 'deleted_at_between',
                    visible: false,
                    orderable: true,
                    className: 'editable col-deleted_at',
                    editField: 'deleted_at',
                },
                {
                    data: 'created_at',
                ...
                },
                {
                    ...
                    render: function ( data, type, full, meta ) {
                        ...
                        var actions = '<a href="/admin/internal_letters/' + id + '?master_show_tab='+ master_show_tab_value +'" class="btn btn-default m-r-5"><span class="glyphicon glyphicon-eye-open"></span></a>';
                        actions += '<a href="/admin/internal_letters/' + id + '" data-confirm="確定刪除?" class="btn btn-default" rel="nofollow" data-method="delete"><span class="glyphicon glyphicon-trash"></span></a>';
                        return actions;
                    },
                },
            ],
        ...
        datatable.on('row-reorder', function(e, diff, edit){
            ...
            $.ajax({
                type: 'patch',
                url: '/admin/internal_letters/update_row_sorting',
                data: data,
                datatype: 'json'
            });
        });
    ...
    // 點擊頁籤
    $('.internal_letter__tab').on('click', function(){
        var tab = $(this);
