...
$(function() {
    ...
    $('.roles_table').each(function(){
        ...
        var datatable = table.DataTable({
            ...
            columns:[
                ...
                },
                {
                    ...
                    visible: true,
                    orderable: true,
                    className: 'editable col-sorting',
                    editField: 'sorting',
                },
                {
                    // 操作
                    ...
                    render: function ( data, type, full, meta ) {
                        ...
                        var actions = '<a href="/admin/roles/' + id + '/edit?master_show_tab='+ master_show_tab_value +'" class="btn btn-default m-r-5"><span class="glyphicon glyphicon-pencil"></span></a>';
                        actions += '<a href="/admin/roles/' + id + '" class="btn btn-default delete-claim-btn" rel="nofollow" data-method="delete" data-id="'+ id +'" data-confirm="確定刪除?"><span class="glyphicon glyphicon-trash"></span></a>';
                        return actions;
                    },
                },
            ],
        ...
        datatable.on('row-reorder', function(e, diff, edit){
            ...
            $.ajax({
                type: 'patch',
                url: '/admin/roles/update_row_sorting',
                data: data,
                datatype: 'json'
            });
        });
