...
$(function() {
    ...
    if( typeof resource_item_id !== 'undefined' && resource_item_id != "" && typeof master_show_tab !== 'undefined' && master_show_tab != "" ) {
        $.ajax({
            url: "/admin/resource_items/"+ resource_item_id +"/render_tab_content",
            method: 'get',
            dataType: 'html',
