                                ...
                                <div class=" bg_color2">
                                    <div class="bg_all">
                                        ...
                                        <div class="list_tt2">
                                            ...
                                            @if(isset($user_roles->role_id))
                                                ...
                                                @if($user_roles->role_id == 1)
                                                    ...
                                                    @if($row->getOriginal('claim_state') == 0 && $row->is_pre_invest == 1 && $rest[$row->claim_id] != 0)

                                                        <a id="send_tender"  
                                                        onclick='swal({title:"提示", text:"目前僅開放單筆1萬元以上可預購，週一早上10點後開放單筆1000元可認購。", type:"info", confirmButtonText: "確認"}).then( value => {location.href="/front/claim_tender/{{ $row->claim_id }}"})'    style="cursor: pointer;">
                                                            <div class="btbt5 "> <i class="fa fa-bars" aria-hidden="true"></i> 預先投標
                                                            </div>
                                                        </a>

                                                    @elseif($row->getOriginal('claim_state') == 1 && $rest[$row->claim_id] != 0)

                                                        <a id="send_tender" href="/front/claim_tender/{{ $row->claim_id }}"
                                                            style="cursor: pointer;">
                                                            <div class="btbt5 "> <i class="fa fa-bars" aria-hidden="true"></i> 投標
                                                            </div>
                                                        </a>
                                            ...
                                            <a href="#calculation" id="calculation_link">
                                                <div class="btbt6"><i class="fa fa-table" aria-hidden="true"></i> 投資試算
                                                </div>
                                            </a>
                                        </div>
                                        <!-- lightbox -->
                                        <div class="lightbox fancy" id="calculation">
                                                ...
                                                <div class="">
                                                    ...
                                                    <div class="panel-body p-0">
                                                            ...
                                                            <div class="cal-bd-tab jCalBdTab">
                                                                <div class="row mt-15">
                                                                        ...
                                                                        <div class="col-xs-8">
                                                                            <div class="input-group">
                                                                                <input type="number"
                                                                                    class="form-control"
                                                                                    style="width: 125px;"
                                                                                    id="investment_amount" min="0"
                                                                                    placeholder="">
                                                                                <div
                                                                                    class="input-group-addon calc-addon">
                                                                                    元</div>
                                                                            </div>
                                                                        </div>
                                                                    </div>
                                                                    <div
                                                                        class="col-md-12 col-sm-12 mt-md-10  mt-sm-10  mt-xs-10 col-xs-12">
                                                                        <div class="col-xs-4 calc-label">年利率</div>
                                                                        <div class="col-xs-8">
                                                                            <div class="input-group">
                                                                                <input type="text" name="nhlv" id="nhlv"
                                                                                    class="form-control"
                                                                                    value="{{ $row->annual_interest_rate }}%"
                                                                                    readonly="">
                                                                                <div
                                                                                    class="input-group-addon calc-addon">
                                                                                    %</div>
                                                                    ...
                                                                    <div class="col-md-12 col-sm-12 mt-10">
                                                                        ...
                                                                        <div class="col-xs-8">
                                                                            <div class="input-group">
                                                                                <input type="text" name="nyy" id="jkqx"
                                                                                    class="form-control"
                                                                                    style="width: 81px;"
                                                                                    value="{{ $row->remaining_periods }}期"
                                                                                    readonly="">
                                                                            </div>
                                                                        </div>
                                                                    </div>
                                                                ...
                                                                <div class="row mt-15">
                                                                    <div class="col-md-12 tc"
                                                                        ...
                                                                        <div class="col-xs-6 tc"
                                                                            ...
                                                                            {{-- edit by J start --}}
                                                                            {{-- <button id="count_btn" class="sub1"
                                                                                onclick="claim_count();">計算</button> --}}
                                                                            <button id="count_btn"
                                                                                class="sub1">計算</button>
                                                                            {{-- edit by J end --}}
                                                                        ...
                                                                        <div class="col-xs-6 tc"
                                                                            ...
                                                                            <input type="button" value="清除"
                                                                                class="reset" id="btn-reset"
                                                                                onclick="clearCountTable();">
                                                        ...
                                                        <div id="bxmx" style="overflow:auto; height: 120vh">
                                                            <table class="table table-striped table-hover carl-record"
                                                                id="repayplan">
                                                                <tbody>
                                                                ...
                                                                <tbody id="appendTag"
                                                                    style="display: table-row-group;text-align:center"
                                                                    class="appendTag">
                                            ...
                                            <a href="#pending"
                                                style="position: absolute; right: 10px; top: 10px; color: #000"><i
                                    ...
                                    <div class="bg_a">
                                        ...
                                        <div class="money_item5">
                                            <div><span class="list_1"><span class="item_data2">上架日期</span> <span
                                                        class="item_data">
                                                        @php
                                            ...
                                            <div><span class="list_1  "><span class="item_data2">預計結標日</span> <span
                                                        class="item_data">
                                ...
                                <div class=" bg_color3">
                                    <div class="bg_d">
                                        ...
                                        <div class="td_co">
                                            ...
                                            <p>每月回饋=被推薦人投資本債權每月月底投資餘額*年利率 {{ $row->commission_interest_rate*100 }}%
                                            /12。</p> --}}
                                        </div>
