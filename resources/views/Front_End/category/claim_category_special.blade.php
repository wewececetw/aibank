...
<?
    $l1=" onclick=window.location=&#39;/front/claim_category_special/".$line_id."/";
    $l2="&#39;";
    $rr[0]="先息後本";
    $rr[1]="本息攤還";
?>
        ...
        <div style="padding: 70px 0px;margin: 0 auto;">
            <ul class="pagination" id='page1'>
                ...
                <li class="paginate_button page-item <? if($line_id==1){ ?>active<? }?>">
                    <a href="/front/claim_category_special/1/{{$c_t}}" aria-controls="claims" data-dt-idx="1" tabindex="0" class="page-link">1</a>
                </li>
<?
if($all_page>5){
        $ll = $line_id -3;
        ...
        for($ll;$ll<=$i;$ll++){
            if($ll > 1){
                ?><li class="paginate_button page-item <? if($ll==$line_id){ ?>active<? }?>">
                    <a href="/front/claim_category_special/{{$ll}}/{{$c_t}}" aria-controls="claims" data-dt-idx="{{$ll}}" tabindex="0" class="page-link">{{$ll}}</a>
                </li><?
            }
        }
        if($i < $all_page -1){
...
?>
                <li class="paginate_button page-item <? if($ll==$line_id){ ?>active<? }?>">
                    <a href="/front/claim_category_special/{{$all_page}}/{{$c_t}}" aria-controls="claims" data-dt-idx="{{$all_page}}" tabindex="0" class="page-link">{{$all_page}}</a>
                </li>
<? }?>
            ...
            <ul class="pagination" id='page2'>
                <li class="paginate_button page-item <? if($line_id==1){ ?>active<? }?>">
                    <a href="/front/claim_category_special/1/{{$c_t}}" aria-controls="claims" data-dt-idx="1" tabindex="0" class="page-link">第一頁</a>
                </li>
                ...
                <li class="paginate_button page-item <? if($ll==$line_id){ ?>active<? }?>">
                    <a href="/front/claim_category_special/{{$all_page}}/{{$c_t}}" aria-controls="claims" data-dt-idx="{{$all_page}}" tabindex="0" class="page-link">最末頁</a>
                </li>            
            </ul>   
        </div>
