                                ...
                                <div class=" bg_color2">
                                                            ...
                                                            <div class="cal-bd-tab jCalBdTab">
                                                                <div class="row mt-15">
                                                                    ...
                                                                    <div class="col-md-12 col-sm-12 mt-10">
                                                                        ...
                                                                        <div class="col-xs-8">
                                                                            <div class="input-group">
                                                                                <input type="text" name="nyy" id="jkqx" class="form-control" style="width: 81px;" value="{{ $row->periods }}期" readonly="">
                                                                            </div>
                                                                        </div>
                                                                    </div>
                                    ...
                                    <div class="bg_a">
                                        ...
                                        <div class="money_item2">
                                            ...
                                            <div><span class="list_5">{{ $row->periods }}期</span></div>
                                        </div>
                                    ...
                                    <div class="bg_d">
                                        ...
                                        @if(Auth::check())
                                            <div class="list_table row">
                                                ...
                                                <div class="td-2">{{ $row->comment }}</div>
                                            </div>
                                        @else
...
?>                                                            </span>
                                                            ...
                                                            <td data-th="投標時間">
                                                            <span class="fbold">
                                                                {{ date('Y-m-d',strtotime($tender->created_at ))}}
                                                            </span>
                                                            </td>
                                                            <td data-th="繳款時間">
                                                            <span class="fbold">
                                                            ...
                                                            未繳款
                                                            @else
                                                                {{ date('Y-m-d',strtotime($tender->paid_at)) }}
                                                                @endif
                                                            </span>
                                                            </td>
                                                        </tr>
...
<script>
    ...
    function showCountingTable(d) {
        ...
        for (x; x < xlen; x++) {
            let td = `
                <td>${x+1}</td>
                <td>${toThousands(d.everyMonthPaidTotal[x])}元</td>
                <td>${toThousands(d.everyMonthPrincipal[x])}元</td>
                <td>${toThousands(d.everyMonthInterest[x])}元</td>
            `;
            let tr = `<tr>${td}</tr>`;
            thtml += tr;
        }
