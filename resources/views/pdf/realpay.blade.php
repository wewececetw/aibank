...
<body>
    <div>
        ...
        <p style="margin:0;font-size:17pt">
            ...
            <span>債權憑證編號</span>
            <span>:</span>
            <span class="specialText">{{ (isset($claim_certificate_number))?$claim_certificate_number:'' }}</span>
            @endif
        </p>
        ...
        <table cellspacing="0" cellpadding="2" style="border-collapse:collapse;">
            ...
            <tr style="height: 20pt">
                ...
                <td class="td2_2">
                        <span style=" color:#0070c0;" >{{ date('Y-m-d',strtotime($claim['value_date'])) }}~{{ date("Y-m-d", strtotime('+'.$claim["periods"].' month', strtotime($claim['value_date']))) }}</span>
                </td>
            </tr>
            <tr style="height: 20pt">
                <td class="td_2">
                ...
                <td class="td2_2">
                   <span style=" color:#0070c0; ">{{ $claim['annual_interest_rate'] }}%</span>
                </td>
            </tr>
            {{-- <tr style="height: 20pt">
                <td class="td_2">
                ...
                <td class="td2_2">
                    <span style=" color:red; ">{{$claim['major_traffic_fines']}}</span>
                </td>
            </tr> --}}
            <tr style="height: 20pt">
                <td class="td_2">
                ...
                <td class="td2_2">
                    <span style=" color:#0070c0; ">{{ (isset($firstPartyTotal))?number_format($firstPartyTotal, 0, '.', ','):0 }}</span>
                </td>
            </tr>
            <tr style="height: 20pt">
                <td class="td_2">
            ...
            <tr style="height: 20pt">
                ...
                <td class="td2_2">
                    <span style=" color:#0070c0; ">{{ $thirdPartyManagmentFeeTotal }}</span>
                </td>
            </tr>
            ...
            <tr style="height:79.15pt">
                ...
                <td
                    ...
                    <p
                        ...
                        <span >  <img src="{{ public_path('/images/seal1.png') }}"></span></p>
                </td>
                <td
                ...
                <td
                    ...
                    <p
                        style="margin-top:1.3pt; margin-right:0.95pt; margin-bottom:0pt; line-height:117%;text-align:center">
                        <span >  <img src="{{ public_path('/images/seal2.png') }}"></span></p>
                </td>
            </tr>
        </table>
