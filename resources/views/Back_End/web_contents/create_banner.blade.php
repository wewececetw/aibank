...
<section id="main-content">
    <section class="wrapper">
        <div class="row">
            <div class="col-lg-12">
                @if(isset($edit))
                <h3 class="page-header">修改-{{ $category_ch_name }}</h3>
                @else
                    ...
                    <form id="news_form">
                        ...
                        <div class="detail_1" style="margin-bottom:40px;">
                            ...
                            <div class="col-sm-12" style="margin:20px auto;">
                                @if(isset($edit))
                                <button type="button" id="createBtn" class="btn btn-info pull-right m-r-5">更新</button>
                                @else
                                <button type="button" id="createBtn" class="btn btn-info pull-right m-r-5">新增</button>
                                @endif
