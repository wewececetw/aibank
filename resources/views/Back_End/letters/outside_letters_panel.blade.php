...
{{-- 
            ...
            <div class="row">
                ...
                <div class="col-lg-12">
                    ...
                    <a href="/admin/inbox_letters_create" style="margin-bottom:10px; margin-left: 23px;"  class="btn btn-info">新增站外信</a>
                    ...
                    <section class="panel">
                        <table id="letter_table" class="table table-striped table-advance table-hover">
                            ...
                            <tbody id='mail_tbody'>
                                ...
                                <tr>
                                    <td>{{$row_data[$dataset->user_id]}}</td>
                                    <td>{{$dataset->title}}</td>
                                    {{-- <td>//echo "$dataset->content"?></td> --}}
                                    <td>{{$dataset->send_time}}</td>
                                    <td>
                                        <div class="btn-group">
                                            <a class="btn btn-info" href="/admin/outside_letters_details/{{$dataset->log_o_letter_id}}"><i class="fa fa-eye"></i></a>
                                            {{-- <button class="btn btn-danger" name="changeValue" onClick="isDisplay_letter({{$dataset->log_o_letter_id}})" ><i class="fa fa-trash-o"></i></button> --}}
                                        </div>
                                    </td>
                                </tr>
                                @empty
...
$(document).ready( function () {
    ...
    $("#submit").click(function(){
            ...
            $.ajax({
            url:"{{ url('/admin/outside_letters/search') }}",
            type: 'post',
            headers:{
